...
function DarkModeToggle({
  ...
  return (
    <button
      ...
      className="rounded-lg p-2 text-[#111827] transition-colors hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800"
    >
      {isDark ? (
        <svg
          className="h-5 w-5"
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#111827] dark:bg-gray-950 dark:text-gray-100">
      ...
      <header className="sticky top-0 z-50 border-b border-gray-100 bg-white/80 backdrop-blur-lg dark:border-gray-800 dark:bg-gray-950/80">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <a
              href="#cta"
              className="hidden rounded-xl bg-[#2563EB] px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-[#2563EB]/25 transition-all hover:bg-[#1D4ED8] hover:shadow-lg hover:shadow-[#2563EB]/30 sm:inline-block"
            >
              Get Started
            </a>
            <button
            ...
            <div className="flex flex-col gap-1">
              {NAV_LINKS.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="rounded-lg px-3 py-2.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-50 hover:text-[#2563EB] dark:text-gray-400 dark:hover:bg-gray-900"
              ...
              <a
                href="#cta"
                className="mt-2 rounded-xl bg-[#2563EB] px-5 py-2.5 text-center text-sm font-semibold text-white shadow-md"
                onClick={() => setMobileMenuOpen(false)}
              >
                Get Started
              </a>
      ...
      >
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-600 sm:text-xl dark:text-gray-400">
            Transform raw data into actionable insights with DataVerse AI — the
            all-in-one platform for intelligent analysis, stunning
            visualizations, and continuous learning.
          </p>

          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a
              href="#cta"
              className="w-full rounded-xl bg-[#2563EB] px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-[#2563EB]/25 transition-all hover:bg-[#1D4ED8] hover:shadow-xl hover:shadow-[#2563EB]/30 sm:w-auto"
            >
              Start Free
            </a>
            <a
              href="#features"
              className="w-full rounded-xl border border-gray-200 bg-white px-8 py-3.5 text-base font-semibold text-[#111827] shadow-sm transition-all hover:border-[#2563EB]/30 hover:shadow-md sm:w-auto dark:border-gray-700 dark:bg-gray-900 dark:text-white dark:hover:border-[#2563EB]/50"
            >
              Explore Features
            </a>
          </div>
          ...
          <div className="mt-16 grid grid-cols-3 gap-6 border-t border-gray-100 pt-10 dark:border-gray-800 sm:gap-12">
            {[
              ...
              <div key={stat.label}>
                <div className="text-2xl font-bold text-[#2563EB] sm:text-3xl">
                  {stat.value}
                </div>
      ...
      <section
        id="features"
        className="bg-gray-50 px-4 py-20 sm:px-6 sm:py-28 lg:px-8 dark:bg-gray-900/50"
      >
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
              Powerful tools designed to help you analyze faster, learn smarter,
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((feature) => (
              <div
                key={feature.title}
                className="group rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-all hover:border-[#2563EB]/20 hover:shadow-lg hover:shadow-[#2563EB]/5 dark:border-gray-800 dark:bg-gray-900 dark:hover:border-[#2563EB]/30"
              >
                <div className={`inline-flex rounded-xl p-3 ${feature.color}`}>
                  {feature.icon}
                </div>
                <h3 className="mt-5 text-lg font-semibold text-[#111827] dark:text-white">
                  {feature.title}
                </h3>
      ...
      {/* Pricing anchor (nav link target) */}
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#2563EB] via-[#1D4ED8] to-[#7C3AED] px-8 py-16 text-center shadow-2xl shadow-[#2563EB]/20 sm:px-16 sm:py-20">
            ...
            <p className="relative mx-auto mt-4 max-w-xl text-lg text-blue-100">
              Join thousands of teams using DataVerse AI to make smarter
              decisions. Start your free trial today — no credit card required.
            </p>
            <div className="relative mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                href="#"
                className="w-full rounded-xl bg-white px-8 py-3.5 text-base font-semibold text-[#2563EB] shadow-lg transition-all hover:bg-gray-50 sm:w-auto"
              >
                Create Free Account
              </a>
              <a
                href="#features"
                className="w-full rounded-xl border border-white/30 px-8 py-3.5 text-base font-semibold text-white transition-all hover:bg-white/10 sm:w-auto"
              >
                View Demo
              </a>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
                ...
                <ul className="mt-4 space-y-3">
                  {links.map((link) => (
                    <li key={link}>
                      <a
                        href="#"
                        className="text-sm text-gray-500 transition-colors hover:text-[#2563EB] dark:text-gray-400 dark:hover:text-[#2563EB]"
                      >
                        {link}
                      </a>
                    </li>
          ...
          <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-gray-100 pt-8 sm:flex-row dark:border-gray-800">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              &copy; {new Date().getFullYear()} DataVerse AI. All rights
              reserved.
            </p>
